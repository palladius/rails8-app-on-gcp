...
Here is the canonical Google Cloud reference architecture you will build and deploy, showcasing our production multi-container Cloud Run service connected to all managed Google Cloud persistence and AI services:

![Rails 8 on Google Cloud: Production Reference Architecture](assets/images/nanobanana_arch_flat.png)

*(Generated by 🍌 **Nano Banana Pro** (Gemini 3 Pro Image) — Also check out our [Isometric 3D render](assets/images/nanobanana_arch_isometric.png) and [Deterministic Graphviz version](assets/images/arch_diagram.png))*
