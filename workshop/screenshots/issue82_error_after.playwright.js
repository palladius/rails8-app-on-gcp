/**
 * Screenshot script: issue-82-error-after
 * Captures the modernized Googley / Gemini styled 500 error page for Issue #82.
 */
...
async function capture() {
  ...
  const outputPath = process.env.SCREENSHOT_OUTPUT || path.resolve(repoRoot, 'workshop/assets/screenshots/issue-82-error-after.png');
  ...
  const placeholderSvg = `<svg xmlns="http://www.w3.org/2000/svg" width="1280" height="800">
    ...
    <text x="50%" y="45%" fill="#818cf8" font-size="32" font-family="sans-serif" text-anchor="middle">500 Internal Error</text>
    <text x="50%" y="55%" fill="#e0e0e0" font-size="20" font-family="sans-serif" text-anchor="middle">Modernized Google/Gemini 500 UI (Issue #82)</text>
  </svg>`;
