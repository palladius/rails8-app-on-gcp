...
Rails.application.config.x.app.workshop_url = "https://github.com/palladius/rails8-app-on-gcp/blob/main/workshop/CODELAB.md"
Rails.application.config.x.app.hive_url = "https://workshop-hive-x42ijqglgq-ew.a.run.app/"
