...
- **Pedagogical Rule:** Never let Ruby syntax or Rails minutiae become a stumbling block. Keep application commands intuitive (`bin/dev`, `bundle install`, `bin/rails db:...`), and use Antigravity / Gemini as the student's personal pair programmer to explain concepts, generate diagrams, and demystify the stack.
